/**
  ******************************************************************************
  * @file    stm322xg_usb_audio_codec.h
  ...
  *     "stm322xg_eval_audio_codec.c" provided by STMicroelectronics for
  *     the STM32F2xx family (in folder Utilities\STM32_EVAL\STM322xG_EVAL).
...
#ifndef __STM322xG_USB_AUDIOCODEC_H
#define __STM322xG_USB_AUDIOCODEC_H

/* Includes ------------------------------------------------------------------*/
#include "stm32f2xx.h"
#include "stm322xg_eval_ioe.h" /* IOExpander driver is included in order to allow 
                                   CS43L22 codec reset pin management on the 
                                   evaluation board */
...
/* Uncomment the following line to use the default Codec_TIMEOUT_UserCallback() 
   function implemented in stm322xg_evel_audio_codec.c file.
...
/* Codec_TIMEOUT_UserCallback() function is called whenever a timeout condition 
   ...
   define USE_DEFAULT_TIMEOUT_CALLBACK in stm322xg_usb_audio_codec.h file.
   Typically the user implementation of this callback should reset I2C peripheral
   and re-initialize communication or in worst case reset all the application. */
uint32_t Codec_TIMEOUT_UserCallback(void);
 
#endif /* __STM322xG_USB_AUDIOCODEC_H */
