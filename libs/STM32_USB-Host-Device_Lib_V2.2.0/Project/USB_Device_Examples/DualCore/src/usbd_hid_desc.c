...
{
  USBD_GetString ((uint8_t *)(uint8_t *)USBD_HID_PRODUCT_FS_STRING, USBD_HID_StrDesc, length);    
...
{
  USBD_GetString ((uint8_t *)(uint8_t *)USBD_HID_MANUFACTURER_STRING, USBD_HID_StrDesc, length);
  return USBD_HID_StrDesc;
}
...
{
  USBD_GetString ((uint8_t *)(uint8_t *)USBD_HID_CONFIGURATION_FS_STRING, USBD_HID_StrDesc, length); 
  return USBD_HID_StrDesc;  
}
...
{
  USBD_GetString ((uint8_t *)(uint8_t *)USBD_HID_INTERFACE_FS_STRING, USBD_HID_StrDesc, length);
  return USBD_HID_StrDesc;  
}
